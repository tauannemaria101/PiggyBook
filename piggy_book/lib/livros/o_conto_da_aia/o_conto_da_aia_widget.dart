                ...
                child: StreamBuilder<List<LivrosRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return InkWell(
                      ...
                      onLongPress: () async {
                        await _model.aia!.reference.delete();
                        await showDialog(
                          context: context,
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          var livrosRecordReference =
                              LivrosRecord.collection.doc('aia');
                          await livrosRecordReference
                              .set(createLivrosRecordData(
                            livroImagem:
                                'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/piggy-book-a23t21/assets/ue1gmdikzsf6/91AHNAr638L._AC_UF1000%2C1000_QL80_.jpg',
                          ));
                          _model.aia = LivrosRecord.getDocumentFromData(
